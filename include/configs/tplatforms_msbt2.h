/*
 * Configuration settings for the Baikal-T1 based MSBT2 boards.
 *
 ...
 */
#ifndef __CONFIG_TPLATFORMS_MSBT2_H
#define __CONFIG_TPLATFORMS_MSBT2_H
...
#define CONFIG_CUSTOM_SPD_FILE		"AS4C1G8D3LA"
...
#define CONFIG_BAIKAL_NAME		"MSBT2"
...
#define CONFIG_SYS_I2C_PCA953X_BUS_NUM	CONFIG_SYS_SHRED_BUS_NUM
#define CONFIG_SYS_I2C_PCA953X_ADDR	CONFIG_SYS_SHRED_I2C_ADDR
...
#define CONFIG_FRU_MAX_IFACES		3
 ...
 *-----------------------------------------------
 */
#if 0 /* Not support at the moment */
...
#endif /* __CONFIG_TPLATFORMS_MSBT2_H */
